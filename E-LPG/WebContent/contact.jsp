...
<head>
	<meta charset="UTF-8">
	<title>Contact || Industry || Responsive HTML 5 Template</title>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-7">
                <div class="contact-form">
                    <form id="contact-form" name="contact_form" class="default-form" action="http://steelthemes.com/demo/html/Industry-Preview/inc/sendmail.php" method="post">
...
<!-- Mirrored from steelthemes.com/demo/html/Industry-Preview/contact.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Sep 2017 21:20:57 GMT -->
</html>