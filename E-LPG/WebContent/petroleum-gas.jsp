            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="left pull-left">
                        ...
                        <li class="active">Petroleum and Gas</li>
                    </ul>
                ...
                <div class="content-box">
                    ...
                    <div class="row top-content">
                        ...
                        <div class="col-md-6">
                            <div class="single-item hvr-sink">
                                <div class="img-holder">
                                    <img src="images/solutions/petroleum-gas-1.jpg" alt="Awesome Image">
                                </div>
                                <div class="text-holder">
                        ...
                        <div class="col-md-6">
                            <div class="single-item hvr-sink">
                                <div class="img-holder">
                                    <img src="images/solutions/petroleum-gas-2.jpg" alt="Awesome Image">
                                </div>
                                <div class="text-holder">
                                    <ul>
                ...
                <div class="left-sidebar">
                    ...
                    <div class="single-sidebar">
                        <ul class="page-link">
                            ...
                            <li><a href="mechanical-engineering.jsp">Mechanical Engineering</a></li>
                            <li><a href="chemical-research.jsp">Chemical Research</a></li>
                            <li class="active"><a href="petroleum-gas.jsp">Petroleum and Gas</a></li>
                            <li><a href="material-engineering.jsp">Material Engineering</a></li>
                            <li><a href="power-energy.jsp">Power and Energy</a></li>              
                        </ul>
                    </div>
...
<!-- Mirrored from steelthemes.com/demo/html/Industry-Preview/petroleum-gas.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Sep 2017 21:18:07 GMT -->
</html>