...
<head>
  ...
  <script type="text/javascript" src="js/bookcylinder.js"></script>
</head>
<body>
<%
...
<br>
<form name="register" onsubmit="return formValidation()" action="Bookcylinder" method="post">
<div>
<center><input type="text" name="cyno" palceholder="Enter The Number Of Cylinder to Book">
