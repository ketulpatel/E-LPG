...
<head>
	<meta charset="UTF-8">
	<title>Shop || Industry || Responsive HTML 5 Template</title>
...
<!--Start shop area-->
 <form action="ShopProduct" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-product-item">
                                ...
                                <div class="title-holder">
                                    <h5 class="product-title">Induction</h5>
                                    <h4 class="product-value">2200 /-</h4>
                                    <div class="botton clearfix">
                                        ...
                                        <div class="review-box pull-right">
                                            <input type="checkbox" name="s1" value="Induction">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-product-item">
                                ...
                                <div class="title-holder">
                                    <h5 class="product-title">Regulator</h5>
                                    <h4 class="product-value">290 /-</h4>
                                    <div class="botton clearfix">
                                        <div class="product-cart pull-left">
                                            <a href="shopping-cart.jsp"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Add to Cart</a>
                                        </div>
                                        <div class="review-box pull-right">
                                            <input type="checkbox" name="s2" value="Regulator">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-product-item">
                                ...
                                <div class="title-holder">
                                    <h5 class="product-title">Cylinder Trolly</h5>
                                    <h4 class="product-value">250 /-</h4>
                                    <div class="botton clearfix">
                                        <div class="product-cart pull-left">
                                            <a href="shopping-cart.jsp"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Add to Cart</a>
                                        </div>
                                        <div class="review-box pull-right">
                                           <input type="checkbox" name="s3" value="Cylinder Trolly">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-product-item">
                                ...
                                <div class="title-holder">
                                    <h5 class="product-title">Lighter</h5>
                                    <h4 class="product-value">150 /-</h4>
                                    <div class="botton clearfix">
                                        <div class="product-cart pull-left">
                                            <a href="shopping-cart.jsp"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Add to Cart</a>
                                        </div>
                                        <div class="review-box pull-right">
                                           <input type="checkbox" name="s4" value="Lighter">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-product-item">
                                ...
                                <div class="title-holder">
                                    <h5 class="product-title">Stove</h5>
                                    <h4 class="product-value">3300 /-</h4>
                                    <div class="botton clearfix">
                                        <div class="product-cart pull-left">
                                            <a href="shopping-cart.jsp"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Add to Cart</a>
                                        </div>
                                        <div class="review-box pull-right">
                                            <input type="checkbox" name="s5" value="Stove">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-product-item">
                                ...
                                <div class="title-holder">
                                    <h5 class="product-title">Gas Pipe</h5>
                                    <h4 class="product-value">130 /-</h4>
                                    <div class="botton clearfix">
                                        <div class="product-cart pull-left">
                                            <a href="shopping-cart.jsp"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Add to Cart</a>
                                        </div>
                                        <div class="review-box pull-right">
                                            <input type="checkbox" name="s6" value="Gas Pipe">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- Mirrored from steelthemes.com/demo/html/Industry-Preview/shop.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Sep 2017 21:20:55 GMT -->
</html>