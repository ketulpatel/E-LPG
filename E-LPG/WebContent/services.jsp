...
<head>
	<meta charset="UTF-8">
	<title>Solutions || Industry || Responsive HTML 5 Template</title>
...
<!--Start solution area-->
<section class="solution-area main-solution-page">
    <div class="container">
        <div class="row">
            <!--Start single item-->
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="single-solution-item">
                    ...
                    <div class="img-holder">
                        <img src="images/solutions/4.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <a href="#">Read More</a>
                    ...
                    <div class="text-holder">
                        <p>We have all come to appreciate energy as the prime mover of our economy...</p>
                    </div>
                </div>
            </div>
            <!--End single item-->
            ...
            <div class="col-md-4">
                <div class="single-solution-item">
                    ...
                    <div class="img-holder">
                        <img src="images/solutions/5.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <a href="#">Read More</a>
                    ...
                    <div class="text-holder">
                        <p>An independent materials and metallurgical engineering, consulting and testing...</p>
                    </div>
                </div>
            </div>
            <!--End single item-->
            ...
            <div class="col-md-4">
                <div class="single-solution-item">
                    <div class="title-holder">
                        ...
                        <p>Sun's energy to provide heat</p>
                        <span class="border"></span>
                    </div>
                    <div class="img-holder">
                        <img src="images/solutions/6.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <a href="#">Read More</a>
                    ...
                    <div class="text-holder">
                        <p>Technologies use the sun's energy and light to provide heat, light and electricity...</p>
                    </div>
                </div>
            </div>
            <!--End single item-->
...
<!-- Mirrored from steelthemes.com/demo/html/Industry-Preview/services.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Sep 2017 21:17:17 GMT -->
</html>