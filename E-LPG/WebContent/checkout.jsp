...
<head>
	<meta charset="UTF-8">
	<title>Checkout || Industry || Responsive HTML 5 Template</title>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <div class="form billing-info">
                    ...
                    <form method="post" action="http://steelthemes.com/demo/html/Industry-Preview/checkout.jsp">
                        <div class="row">
                            <div class="col-md-12">
...
<!-- Mirrored from steelthemes.com/demo/html/Industry-Preview/checkout.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Sep 2017 21:20:57 GMT -->
</html>